...
namespace Book_Store.Extensions
{
    internal static class DatabaseSeedDataExtensions
    {
        public static void SeedData(this ModelBuilder modelBuilder)
        {
            ...
            var images = new[]
            {
                new Image { Id = 1, ImageTitle = "default", ImageData = DefaultBookCovers.default_book_cover },
                new Image { Id = 2, ImageData = DefaultBookCovers.Harry_Potter_and_the_Philosopher_s_Stone_Book_Cover },
                new Image { Id = 3, ImageData = DefaultBookCovers.Harry_Potter_and_the_Chamber_of_Secrets }
            };
            ...
            var discounts = new[]
            {
                new Discount
                {
                    Id = 1, Name = "Harry Potter Discount", Percent = 70,
