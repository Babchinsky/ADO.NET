...
VALUES ('Ручки'), ('Карандаши'), ('Блокноты'), ('Скрепки');

INSERT INTO Managers (Name)
VALUES ('Иван Иванов'), ('Петр Петров'), ('Анна Сидорова'), ('Мария Николаева');

INSERT INTO Firms (Title)
VALUES ('Офисная компания 1'), ('Офисная компания 2'), ('Офисная компания 3');

INSERT INTO Stationery (Title, Quantity, Cost, TypeId)
VALUES ('Ручка гелевая', 100, 50, 1),
       ('Карандаш цветной', 80, 70, 2),
       ('Блокнот формата A4', 120, 30, 3),
       ('Скрепки маленькие', 200, 20, 4);
...
INSERT INTO TypesOfStationery (Title)
VALUES ('Калькуляторы'), ('Ежедневники'), ('Аккумуляторы');

INSERT INTO Managers (Name)
VALUES ('Ирина Ефимова'), ('Алексей Смирнов'), ('Татьяна Иванова');

INSERT INTO Firms (Title)
VALUES ('Офисная компания 4'), ('Офисная компания 5'), ('Офисная компания 6');

INSERT INTO Stationery (Title, Quantity, Cost, TypeId)
VALUES ('Калькулятор для офиса', 150, 10, 5),
       ('Ежедневник формата A5', 90, 40, 6),
       ('Аккумуляторы AA', 80, 25, 7);
